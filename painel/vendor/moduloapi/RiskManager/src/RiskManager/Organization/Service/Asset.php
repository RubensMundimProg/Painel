...
use RiskManager\Organization\Entity\Asset as Entity;

/**
 *
 * Classe Service que processa informações dos ativos
 *
...
class Asset extends Entity{
    protected $url = '/api/Organization/assets';
    ...
    public function getInfoAttributes(){
        $request = new Request();
        $request->setType('GET');
        $request->setUrl('/api/organization/info/assets/attributes');
        $request->setService($this);
        $result = $request->send();
        return $result;
    }
