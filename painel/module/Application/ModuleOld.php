...
class Module
{
    public function onBootstrap(MvcEvent $e)
    {
        ...
        $sharedEvents->attach('Laminas\Mvc\Controller\AbstractController', MvcEvent::EVENT_DISPATCH, array($this, 'controllerDispatch'), 100);
    ...
    public function controllerDispatch(MvcEvent $e)
    {
        ...
        /// Rota de Console
        if($controller->getRequest() instanceof \Laminas\Console\Request) return true;
