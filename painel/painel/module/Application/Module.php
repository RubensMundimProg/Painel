...
class Module
{
    ...
    // --- TRADUÇÃO / VALIDAÇÃO (ajustado para Laminas) ---
    ...
    // Usa o arquivo de tradução do Laminas, não do Zend
   ...
   public function controllerDispatch(MvcEvent $e)
    {
        ...
        if ($controller->getRequest() instanceof \Laminas\Console\Request || in_array($route['controller'], $listaBranca)) {
            return true;
        }
