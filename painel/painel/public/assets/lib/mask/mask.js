...
$(function(){
    ...
    $('body').on("focus",'input[data-mask]',function(){
        if(!$(this).hasClass('formatado')){
            aplicarMascaras($(this));
        }
    })
})
...
function aplicarMascaras($this){
    var attr = $this.attr('data-mask');
    $this.addClass('formatado');

    if(attr == 'money'){

    }else if(attr == 'int'){
        $this.apenasNumeros();
    }else if(attr == 'telefone'){
    ...
    {
        var mask = {cep:'99.999-999',date:'99/99/9999', telefone:'(999) 9999-9999',cpf:'999.999.999-99',cnpj:'99.999.999/9999-99'};
        //$(this).mask(mask.telefone);
    }
}


function aplicarLimite(){
    $('input.limite').keydown(function(){
