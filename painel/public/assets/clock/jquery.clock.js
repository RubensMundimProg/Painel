...
(function(jQuery)
{
  jQuery.fn.clock = function(options)
  {
    ...
    setInterval( function() {
      ...
      {
        jQuery(_this).find(".sec").html((seconds<10)?'0'+seconds:seconds);
      }
    }, 1000 );
    ...
    setInterval( function() {
      ...
      {
        jQuery(_this).find(".hour").html((hours<10)?'0'+hours+':':hours+':');
      }
    ...
    setInterval( function() {
      ...
      {
        jQuery(_this).find(".min").html((mins<10)?'0'+mins+':':mins+':');
      }
    }, 1000 );
  }
})(jQuery);
